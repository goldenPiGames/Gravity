class BasicHUD {
	...
	draw() {
		...
		this.sprites1.drawOnMain(this.engine.playing ? "timerPlaying" : "timerPaused", {alpha:.5, x:0, y:0, xadj:0, yadj:0, scale:2});
		...
		this.sprites1.drawOnMain(this.engine.camera.rotateWithFocus ? "cameraRotate" : "cameraFixed", {alpha:.5, x:mainCanvas.width, y:0, xadj:1, yadj:0, scale:2});
	}
	startDialog(...stuff) {
