const COMMAND_LIST = ["menuLeft", "menuRight", "menuUp", "menuDown", "select", "cancel", "menuAlt", "left", "right", "up", "down", "gear", "jump", "pause", "restart", "cameraLeft", "cameraRight", "cameraUp", "cameraDown"];
